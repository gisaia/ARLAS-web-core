...
<h3 id="aggregatepost-responses">Responses</h3>
...
<h3 id="shapeaggregatepost-parameters">Parameters</h3>
...
<h3 id="shapeaggregatepost-responses">Responses</h3>
...
|---|---|---|---|---|
|collection|path|string|true|collection|
|field|query|string|true|The field on which the metric is calculated.|
|metric|query|string|true|The metric to compute : `max, min, avg, sum, cardinality, spanning, geobbox, geocentroid`.|
|f|query|array[string]|false|- A triplet for filtering the result. Multiple filter can be provided in distinct parameters (AND operator is applied) or in the same parameter separated by semi-colons (OR operator is applied). The order does not matter. |
|q|query|array[string]|false|A full text search. Optionally, it's possible to search on a field using this syntax: {fieldname}:{text}|
|dateformat|query|string|false|The format of dates. This parameter should be set only if a date field is queried in `f` param; when using `gt`, `lt`, `gte`, `lte` and `range` operations|
|righthand|query|boolean|false|If righthand = true, the passed WKT should be counter clock-wise; otherwise, ARLAS-server will attempt to parse it as the "Complementary" Polygon on the other facet of the planet. |
...
<h3 id="compute-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[ComputationResponse](#schemacomputationresponse)]|false|none|none|
...
<h3 id="computepost-parameters">Parameters</h3>
...
<h3 id="computepost-responses">Responses</h3>
...
<h3 id="count-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|[[Hits](#schemahits)]|false|none|none|
|» collection|string|false|none|none|
|» hits|[[ArlasHit](#schemaarlashit)]|false|none|none|
...
<h3 id="countpost-parameters">Parameters</h3>
...
<h3 id="countpost-responses">Responses</h3>
...
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad request.|[Error](#schemaerror)|
|403|[Forbidden](https://tools.ietf.org/html/rfc7231#section-6.5.3)|Collection not authorized.|[Error](#schemaerror)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Arlas Server Error.|[Error](#schemaerror)|
...
<h3 id="getarlashit-parameters">Parameters</h3>
...
<h3 id="getarlashit-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Successful operation|[ArlasHit](#schemaarlashit)|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|Bad request.|[Error](#schemaerror)|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|Not Found Error.|[Error](#schemaerror)|
|500|[Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1)|Arlas Server Error.|[Error](#schemaerror)|
...
|pretty|query|boolean|false|Pretty print|
|flat|query|boolean|false|Flats the property map: only key/value on one level|
|include|query|string|false|List the name patterns of the field to be included in the result. Separate patterns with a comma.|
|exclude|query|string|false|List the name patterns of the field to be excluded in the result. Separate patterns with a comma.|
|returned_geometries|query|string|false|Comma separated geometry field_paths to be included in the result. If not specified, only geometry_path is returned. If geometry_path is null, then centroid_path is returned|
...
<h3 id="geosearchpost-parameters">Parameters</h3>
...
<h3 id="geosearchpost-responses">Responses</h3>
...
<h3 id="shapesearchpost-parameters">Parameters</h3>
...
<h3 id="shapesearchpost-responses">Responses</h3>
...
<h3 id="tiledgeosearch-parameters">Parameters</h3>
...
<h3 id="tiledgeosearch-responses">Responses</h3>
...
<h3 id="tiledgeosearch_1-parameters">Parameters</h3>
...
<h3 id="tiledgeosearch_1-responses">Responses</h3>
...
<h2 id="tocS_CollectionOrganisations">CollectionOrganisations</h2>
<!-- backwards compatibility -->
<a id="schemacollectionorganisations"></a>
<a id="schema_CollectionOrganisations"></a>
<a id="tocScollectionorganisations"></a>
<a id="tocscollectionorganisations"></a>
...
<!-- backwards compatibility -->
<a id="schemacollectionreferenceupdateorg"></a>
<a id="schema_CollectionReferenceUpdateOrg"></a>
<a id="tocScollectionreferenceupdateorg"></a>
<a id="tocscollectionreferenceupdateorg"></a>
...
<h2 id="tocS_ArlasHit">ArlasHit</h2>
<!-- backwards compatibility -->
<a id="schemaarlashit"></a>
<a id="schema_ArlasHit"></a>
<a id="tocSarlashit"></a>
<a id="tocsarlashit"></a>
